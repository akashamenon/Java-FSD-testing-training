drop database project_movie_data;
...
mov_lang varchar(50) not null,mov_dt_rel date,mov_rel_country varchar(10))auto_increment=901;
...
rev_stars int,num_o_ratings int,foreign key(mov_id) references movie(mov_id),
...
values('Alfred','Hitchcock'),('Jack','Clayton'),('David','Lean'),('Michael','Cimino'),('Milos','Forman'),
('Ridley','Scott'),('Stanley','Kubrick'),('Bryan','Singer'),('Roman','olanski'),('Paul','Thomas Anderson'),
('Woody','Allen'),('Hayao','Miyazaki'),('Frank','Darabont'),('Sam','Mendes'),('James','Cameron'),
('Gus',' Van Sant'),('John',' Boorman'),('Danny','Boyle'),('Christopher','Nolan'),('Richard','Kelly'),
...
('Chinatown',1974,130,'English','1974-08-09','UK'),('Boogie Nights',1997,155,'English','1998-02-16','UK'),
('Annie Hall',1977,93,'English','1977-04-20','USA'),('Princess Mononoke',1997,134,'Japanese','2001-10-19','UK'),
('The Shawshank Redemption','1994','142','English',' 1995-02-17','UK'),
('American Beauty',1999,122,'English',null,'UK'),('Titanic',1997,194,'English','1998-01-23','UK'),
('Good Will Hunting',1997,126,'English','1998-06-03','UK'),('Deliverance',1972,109,'English','1982-10-05','UK'),
('Trainspotting',1996,94,'English','1996-02-23','UK'),('The Prestige',2006,130,'English','2006-11-10','UK'),
('Donnie Darko',2001,113,'English',null,'UK'),('Slumdog Millionaire',2008,120,'English','2009-01-09','UK'),
('Aliens',1986,137,'English','1986-08-29','UK'),('Beyond the Sea',2004,118,'English','2004-11-26','UK'),
('Avatar',2009,162,'English','2009-12-17','UK'),('Seven Samurai',1954,207,'Japanese','1954-04-26','JP'),
('Spirited Away',2001,125,'Japanese','2003-09-12','UK'),('Back to the Future',1985,116,'English','1985-12-04','UK'),
('Braveheart',1995,178,'English','1995-09-08','UK');


insert into movie_direction(dir_id,mov_id)
values(201,901),(202,902),(203,903),(204,904),(205,905),(206,906),(207,907),(208,908),
(209,909),(210,910),(211,911),(212,912),(213,913),(214,914),(215,915),(216,916),(217,917),
...
('Jack','Nicholson','M'),('Mark','Wahlberg','M'),('Woody','Allen','M'),('Claire','Danes','F'),('Tim','Robbins','M'),
('jon','Voight','M'),('Kevin','Spacey','M'),('Kate','Winslet','F'),('Robin','Robbins','M'),('Ewan','McGregor','M'),
('Christian','Bale','M'),('Maggie','Gyllenhaal','F'),('Dev','Patel','M'),('Sigourney','Weaver','F'),
...
(115,915,'Rose DeWitt Bukater'),(116,916,'Sean Maguire'),(117,917,'Ed'),(118,918,'Renton'),
(120,920,'Elizabeth Darko'),(121,921,'Older Jamal'),(122,922,'Ripley'),(114,923,'Bobby Darin'),
...
('Victor Woeltjen'),('Simon Wright'),('Neal Wruck'),('Paul Monks'),('Mike Salvati'),(null),
('Weasly S.Walker'),('Sasha Goldshtein'),('Josh Cates'),('Krug Stillo'),('Scott LeBrun'),('Hannah Steele'),
('Vincent Cadena'),('Brandt Sponseller'),('Richard Adams');


insert into movie_generes(mov_id,gen_id)values(922,1001),(917,1002),(903,1002),(912,1003),(911,1005),
(908,1006),(913,1006),(926,1007),(928,1007),(918,1007),(921,1007),(902,1008),(923,1009),(907,1010),(927,1010),
